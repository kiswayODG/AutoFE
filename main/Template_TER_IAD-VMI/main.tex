...
{\small Encadré par Prénom \textsc{Nom}}}
...
\begin{document}
    ...
    L'introduction de votre rapport doit présenter le contexte dans lequel se déroule votre TER, et la nature du travail qui vous est demandé.
